import { ArrowLeft, Bot, Crown, Heart, Sparkles } from "lucide-react";
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-400">Exclusive Features</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-md w-full">
          <div className="glass-card rounded-2xl p-8 backdrop-blur-xl border border-white/10 sidebar-glow text-center">
            <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-r from-pink-500 to-purple-600 flex items-center justify-center shadow-lg sidebar-icon-glow gentle-floating">
            ...
            <p className="text-gray-400 mb-8 leading-relaxed">
              Unlock premium features for the ultimate honeymoon planning experience! Exclusive AI models, priority support, and luxury travel perks await you.
            </p>
            ...
            <div className="mt-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full border border-purple-500/30 sidebar-glow">
                ...
                <span className="text-sm text-purple-300 glow-text">Premium Experience</span>
              </div>
            </div>
          </div>
        </div>
